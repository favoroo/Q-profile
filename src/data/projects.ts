...
export const projects: Project[] = [
  /* ── 重点项目：全宽横幅大卡片 ── */
  {
    ...
    description:
      '负责整个高压测量数据项目的流程开发，覆盖从 **UE 交互设计**到**测量流程落地**的完整链路，打通界面与测试环节。',
    points: [
      '负责**全体数据的开发**，包含高压系统框图，图片的绘制。',
      '落地高压测量流程，保障**测量数据准确、流程规范**',
      '**独立制作**一整套从开发到落地的**全流程提效工具**',
    ],
  ...
  /* ── AI 工具项目 ── */
  {
    ...
    points: [
      '**设计并主导**整个翻译 Agent 工具的开发',
      '覆盖**翻译与规范化整改**，直接服务翻译同事日常提效',
    ],
  ...
  },
  {
    ...
    description:
      '参与资料治理 Agent 的开发：从大量资料中提取信息、梳理为**可检索的知识库**，让 Agent 工具可以快速检索使用。',
    points: [
      '从海量资料中**提取关键信息并结构化**',
      '梳理成**可检索知识库**，供 Agent 工具检索调用',
    ],
