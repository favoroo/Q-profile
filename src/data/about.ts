...
export const about: About = {
  ...
  paragraphs: [
    '我是黄谦，现就职于湖南道通科技，担任汽车技术工程师。在四轮定位，VIN码解析和新能源高压测量等核心业务中积累了扎实的落地经验，擅长用严谨的工程思维将方案转化为可量产交付的标准流程。',
    '近两年我将技术视野拓展至 AI Agent 自动化提效：主导推进了部门翻译整改Agent工具、海量资料治理与智能知识库检索工具的设计与落地，以数字化工具重塑团队生产力。',
  ],
  quote: {
